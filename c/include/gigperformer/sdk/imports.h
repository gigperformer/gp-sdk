...
extern "C"
{
    ...
    typedef void (*TGP_SetWidgetBounds)(LibraryHandle h, int left, int top, int width, int height);
    typedef void (*TGP_GetWidgetBounds)(LibraryHandle h, int *left, int *top, int *width, int *height);
